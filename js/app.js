				...
				$.ajax({
						...
						success:function jsonCallback(data){
							...
							$.each(data, function(i, field){
								...
								htmlText1 += '<div class="item-inner ltr">';
								...
								htmlText1 += '<div class="item-after timefont ltr">' + data[i].dDate + '<br> ' + data[i].dTime + '</div>';
								htmlText1 += '</div></a></li>';
								
								htmlText1 += '<div class="popover popover-' + data[i].id + '">';
								htmlText1 += '<div class="popover-angle"></div>';
								htmlText1 += '<div class="popover-inner">';
								htmlText1 += '<div class="content-block ltr">';
								htmlText1 += '<a href="#" class="timefont close-popover">X Close</a>';
								htmlText1 += '<div class="row no-gutter ltr">';
								htmlText1 += '<div class="col-50 blue fixedheight">';
								htmlText1 += '<div class="card-content">';
								htmlText1 += '<div class="content-block">';
								htmlText1 += '<h4 class="maintitle col-100 ltr">' + data[i].dAirportName + ' (' + data[i].dAirportCode + ')</h4>';
								htmlText1 += '<h6 class="col-100 ltr">' + data[i].dDate + '<br>' + data[i].dTime + '</h6>';
								htmlText1 += '<div class="clear"></div>';
								htmlText1 += '</div>';
								htmlText1 += '<div class="clear"></div>';
								htmlText1 += '</div>';
								htmlText1 += '</div>';
								htmlText1 += '<div class="col-5 green fixedheight">';
								htmlText1 += '<div class="card-content">';
								htmlText1 += '<div class="content-block">';
								...
								htmlText1 += '<div class="card-content">';
								htmlText1 += '<div class="content-block">';
								htmlText1 += '<h4 class="maintitle col-100 ltr">' + data[i].aAirportName + ' (' + data[i].aAirportCode + ')</h4>';
								htmlText1 += '<h6 class="col-100 ltr">' + data[i].aDate + '<br>' + data[i].aTime + '</h6>';
								htmlText1 += '<div class="clear"></div>';
								htmlText1 += '</div>';
								htmlText1 += '<div class="clear"></div>';
								htmlText1 += '</div>';
								htmlText1 += '</div>';          
								htmlText1 += '</div>';
								htmlText1 += '<p class="ltr"><h4><img src="img/airlines/' + data[i].logoname + '" width="100" alt="' + data[i].logoalt + '">' + data[i].airline + ' ' + data[i].flight + '</h4></p>';
								...
								htmlText1 += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Duration:</i> ' + data[i].flightDuration + ' minutes </div></div></li>';
								htmlText1 += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Departure Terminal:</i> ' + data[i].dTerminal + '</div></div></li>';
								htmlText1 += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Plane:</i> ' + data[i].plane + '</div></div></li>';
								htmlText1 += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Wide Body:</i> ' + data[i].widebody + '</div></div></li>';
								htmlText1 += '<li><div class="item-inner ltr"><div class="item-title smallfont"><span class="badge bg-' + data[i].statuscolor + '">' + data[i].statusname + '</div></div></li>';
								htmlText1 += '</ul></div>';
								htmlText1 += '<div class="ltr" onclick="window.plugins.socialsharing.share(\'Flight Information. ' + data[i].airline + ' ' + data[i].flight + '\', null, null, \'' + data[i].dDate + ' ' + data[i].dTime + '. Arrival: ' + data[i].aDate + ' ' + data[i].aTime + '\')">';
				...
				$.ajax({
						...
						success:function jsonCallback(data){
							...
							$.each(data, function(i, field){
								...
								htmlText += '<div class="item-inner ltr">';
								...
								htmlText += '<div class="item-after timefont ltr">' + data[i].dDate + '<br> ' + data[i].dTime + '</div>';
								htmlText += '</div></a></li>';
								
								htmlText += '<div class="popover popover-' + data[i].id + '">';
								htmlText += '<div class="popover-angle"></div>';
								htmlText += '<div class="popover-inner">';
								htmlText += '<div class="content-block ltr">';
								htmlText += '<a href="#" class="timefont close-popover">X Close</a>';
								htmlText += '<div class="row no-gutter ltr">';
								htmlText += '<div class="col-50 blue fixedheight">';
								htmlText += '<div class="card-content">';
								htmlText += '<div class="content-block">';
								htmlText += '<h4 class="maintitle col-100 ltr">' + data[i].dAirportName + ' (' + data[i].dAirportCode + ')</h4>';
								htmlText += '<h6 class="col-100 ltr">' + data[i].dDate + '<br>' + data[i].dTime + '</h6>';
								htmlText += '<div class="clear"></div>';
								htmlText += '</div>';
								htmlText += '<div class="clear"></div>';
								htmlText += '</div>';
								htmlText += '</div>';
								htmlText += '<div class="col-5 green fixedheight">';
								htmlText += '<div class="card-content">';
								htmlText += '<div class="content-block">';
								...
								htmlText += '<div class="card-content">';
								htmlText += '<div class="content-block">';
								htmlText += '<h4 class="maintitle col-100 ltr">' + data[i].aAirportName + ' (' + data[i].aAirportCode + ')</h4>';
								htmlText += '<h6 class="col-100 ltr">' + data[i].aDate + '<br>' + data[i].aTime + '</h6>';
								htmlText += '<div class="clear"></div>';
								htmlText += '</div>';
								htmlText += '<div class="clear"></div>';
								htmlText += '</div>';
								htmlText += '</div>';          
								htmlText += '</div>';
								htmlText += '<p class="ltr"><h4><img src="img/airlines/' + data[i].logoname + '" width="100" alt="' + data[i].logoalt + '">' + data[i].airline + ' ' + data[i].flight + '</h4></p>';
								//htmlText1 += '<p><i class="color-blue">from:</i> ' + data[i].dAirportName + ' (' + data[i].dAirportCode + ')<br><i class="color-blue">to:</i> ' + data[i].aAirportName + ' (' + data[i].aAirportCode + ')<br><i class="color-blue">departure:</i> ' + data[i].dDate + ' ' + data[i].dTime + '<br><i class="color-blue">actual:</i> ' + data[i].dDateActual + ' ' + data[i].dTimeActual + '<br><i class="color-blue">arrival:</i> ' + data[i].aDate + ' ' + data[i].aTime + '<br><i class="color-blue">actual:</i> ' + data[i].aDateActual + ' ' + data[i].aTimeActual + '<br><i class="color-blue">duration:</i> ' + data[i].flightDuration + ' minutes<br><i class="color-blue">departure terminal:</i> ' + data[i].dTerminal + '<br><i class="color-blue">plane:</i> ' + data[i].plane + '<br><i class="color-blue">widebody:</i> ' + data[i].widebody + '<br><i class="color-blue">tail number:</i> ' + data[i].tailNumber + '<br><span class="badge bg-' + data[i].statuscolor + '">' + data[i].statusname + '</span></p>';
								htmlText += '<div class="list-block"><ul>';
								htmlText += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Duration:</i> ' + data[i].flightDuration + ' minutes </div></div></li>';
								htmlText += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Departure Terminal:</i> ' + data[i].dTerminal + '</div></div></li>';
								htmlText += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Plane:</i> ' + data[i].plane + '</div></div></li>';
								htmlText += '<li><div class="item-inner ltr"><div class="item-title smallfont"><i class="color-blue">Wide Body:</i> ' + data[i].widebody + '</div></div></li>';
								htmlText += '<li><div class="item-inner ltr"><div class="item-title smallfont"><span class="badge bg-' + data[i].statuscolor + '">' + data[i].statusname + '</div></div></li>';
								htmlText += '</ul></div>';
								htmlText += '<div class="ltr" onclick="window.plugins.socialsharing.share(\'Flight Information. ' + data[i].airline + ' ' + data[i].flight + '\', null, null, \'' + data[i].dDate + ' ' + data[i].dTime + '. Arrival: ' + data[i].aDate + ' ' + data[i].aTime + '\')">';
