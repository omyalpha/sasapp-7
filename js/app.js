				...
				$.ajax({
						...
						success:function jsonCallback(data){
							...
							$.each(data, function(i, field){
								...
								htmlText1 += '<div class="content-block">';
								htmlText1 += '<h4 class="maintitle col-100">' + data[i].dAirportName + ' (' + data[i].dAirportCode + ')</h4>';
								htmlText1 += '<h6 class="col-100">' + data[i].dDate + '<br>' + data[i].dTime + '</h6>';
								...
								htmlText1 += '<div class="card-content">';
								htmlText1 += '<div class="content-block">';
								htmlText1 += '<h4 class="maintitle col-100 ">' + data[i].aAirportName + ' (' + data[i].aAirportCode + ')</h4>';
								htmlText1 += '<h6 class="col-100">' + data[i].aDate + '<br>' + data[i].aTime + '</h6>';
								htmlText1 += '<div class="clear"></div>';
								htmlText1 += '</div>';
								htmlText1 += '<div class="clear"></div>';
								htmlText1 += '</div>';
				...
				$.ajax({
						...
						success:function jsonCallback(data){
							...
							$.each(data, function(i, field){
								...
								htmlText += '<div class="content-block">';
								htmlText += '<h4 class="maintitle col-100">' + data[i].dAirportName + ' (' + data[i].dAirportCode + ')</h4>';
								htmlText += '<h6 class="col-100">' + data[i].dDate + '<br>' + data[i].dTime + '</h6>';
								...
								htmlText += '<div class="card-content">';
								htmlText += '<div class="content-block">';
								htmlText += '<h4 class="maintitle col-100 ">' + data[i].aAirportName + ' (' + data[i].aAirportCode + ')</h4>';
								htmlText += '<h6 class="col-100">' + data[i].aDate + '<br>' + data[i].aTime + '</h6>';
								htmlText += '<div class="clear"></div>';
								htmlText += '</div>';
								htmlText += '<div class="clear"></div>';
								htmlText += '</div>';
